...
RESTful web API.  See the [rendered OpenAPI document](https://api.stacspec.org/v1.0.0-beta.5/core) for more details.
...
| `/api`                                              | [OAFeat](ogcapi-features)  | service-desc      | JSON (OpenAPI 3.0 or 3.1)                                                                           | The OpenAPI definition of the endpoints in this service                                                                                    |
