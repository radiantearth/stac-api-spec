...
| `/search`                                           | [Item Search](item-search) | search            | [ItemCollection](core/itemcollection-spec.md)                                    | Retrieves a group of Items matching the provided search predicates, probably containing search metadata from the `search` extension |
