...
| Extension Name                                                                    | Scope                                                                                                     | Fragment                               | Conformance URI                                                            | Description                                                                                                                             | Maturity   |
|-----------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------|----------------------------------------|----------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------|------------|
| [Fields](item-search/README.md#fields)                                            | [Item Search](item-search/) request                                                                        | [Fields](fragments/fields/README.md)   | <http://stacspec.org/spec/api/1.0.0-beta.1/extensions/item-search#fields>  | Adds parameter to control which fields are returned in the response.                                                                    | *Pilot*    |
| [Query](item-search/README.md#query)                                              | [Item Search](item-search/) request                                                                        | [Query](fragments/query/README.md)     | <http://stacspec.org/spec/api/1.0.0-beta.1/extensions/item-search#query>   | Adds parameter to search Item and Collection properties.                                                                                | *Pilot*    |
| [Context](item-search/README.md#context)                                          | [Item Search](item-search/) response ([ItemCollection](core/itemcollection-spec.md))                       | [Context](fragments/context/README.md) | <http://stacspec.org/spec/api/1.0.0-beta.1/extensions/item-search#context> | Adds search related metadata (context) to ItemCollection.                                                                               | *Proposal* |
| [Sort](item-search/README.md#sort)                                                | [Item Search](item-search/) request                                                                        | [Sort](fragments/sort/README.md)       | <http://stacspec.org/spec/api/1.0.0-beta.1/extensions/item-search#sort>    | Adds Parameter to control sorting of returns results.                                                                                   | *Pilot*    |
