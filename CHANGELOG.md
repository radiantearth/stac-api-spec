...
- Added fragment for CollectionCollection
- Added `numberMatched` and `numberReturned` to `GET /collections` endpoint
- Item Search: Added optional conformance class to require the `collections` parameter
